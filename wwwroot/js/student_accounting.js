$(document).ready(function () {
  var studentModel = {
    ...
    registration: [545.0, 550.0, 555.0, 560.0, 565.0, 570.0, 610.0, 624.0],
    misc: [
      1000.45, 1050.35, 1100.25, 1150.15, 1200.05, 1249.05, 1299.85, 1340.75,
    ],
    labfee: [
      1900.75, 1900.2, 1939.65, 1959.1, 1978.55, 1998.0, 2017.45, 2036.9,
    ],
  };
      ...
      success: function (response) {
        if (response && response.length > 0) {
          ...
          $.each(response, function (i, res) {
            ...
            row.append(
              $("<td>").text(parseFloat(res.total_tuition_units.toFixed(2)))
            );
            ...
            var editButton = $(
              '<button type="button" class="btn btn-success btn-sm btn-pay" data-bs-toggle="modal" data-bs-target="#DataModal2">Edit</button>'
            );
  ...
  $("#DataModal2").on("shown.bs.modal", function (e) {
    ...
    var asssessment = ["prelim", "midterm", "semifinal", "final"];
      ...
      $.ajax({
        ...
        success: function (response) {
          if (response) {
            ...
            var payment =
              selectedAssessmentName.toLowerCase() == "prelim"
                ? res.prelim_payment
                : selectedAssessmentName.toLowerCase() == "midterm"
                ? res.midterm_payment
                : selectedAssessmentName.toLowerCase() == "semifinal"
                ? res.semifinal_payment
                : res.final_payment;

            let n = res[a];
            let word = translate(n);
            ...
            if (payment == 0.0) {
              ...
              $("#DataModal2 .modal-footer button:nth-child(2)").removeAttr(
                "disabled"
              );
            } else {
              $("#DataModal2 form #amount_tendered").attr(
                "disabled",
                "disabled"
              );
              $("#DataModal2 .modal-footer button:nth-child(2)").attr(
                "disabled",
                "disabled"
              );
    ...
    $("#DataModal2 .modal-footer button:nth-child(2)")
      ...
      .on("click", function () {
        if (
          parseFloat(
            $("#DataModal2 form #amount_tendered").val() / Math.pow(10, 2)
          ) > assessment_value
        ) {
          $.ajax({
  ...
  $("#DataModal .modal-footer button:nth-child(2)")
    .off("click")
    .on("click", function () {
      let user = $("#DataModal form")
  ...
  function translate(n) {
    ...
    switch (Math.floor((n % 10000) / 1000)) {
      ...
      case 5:
        ...
        break;
      case 6:
        thousandsWord = "Six Thousand ";
        break;
      case 7:
        thousandsWord = "Seven Thousand ";
        break;
      case 8:
        thousandsWord = "Eight Thousand ";
        break;
      case 9:
        thousandsWord = "Nine Thousand ";
        break;
    }
    ...
    switch (Math.floor((n % 100000) / 10000)) {
      ...
      case 1:
        switch (Math.floor(n / 1000)) {
          case 10:
            tensthousandsWord = "Ten Thousand ";
            break;
          case 11:
            tensthousandsWord = "Eleven Thousand ";
            break;
          case 12:
            tensthousandsWord = "Twelve Thousand ";
            break;
          case 13:
            tensthousandsWord = "Thirteen Thousand ";
            break;
          case 14:
            tensthousandsWord = "Fourteen Thousand ";
            break;
          case 15:
            tensthousandsWord = "Fifteen Thousand ";
            break;
          case 16:
            tensthousandsWord = "Sixteen Thousand ";
            break;
          case 17:
            tensthousandsWord = "Seventeen Thousand ";
            break;
          case 18:
            tensthousandsWord = "Eighteen Thousand ";
            break;
          case 19:
            tensthousandsWord = "Nineteen Thousand ";
            break;
        }
        break;
      case 2:
        tensthousandsWord = "Twenty ";
        break;
      case 3:
        tensthousandsWord = "Thirty ";
        break;
      case 4:
        tensthousandsWord = "Forty ";
        break;
      case 5:
        tensthousandsWord = "Fifty ";
        break;
      case 6:
        tensthousandsWord = "Sixty ";
        break;
      case 7:
        tensthousandsWord = "Seventy ";
        break;
      case 8:
        tensthousandsWord = "Eighty ";
        break;
      case 9:
        tensthousandsWord = "Ninety ";
        break;
    }
    let fourthDigit;
    ...
    word =
      (tensthousandsWord !== ""
        ? n > 20999
          ? tensthousandsWord + " " + fourthDigit + " Thousand "
          : tensthousandsWord
        : thousandsWord) +
      hundreds +
      tensWord +
      " " +
      (teensWord !== "" ? teensWord : onesWord);
